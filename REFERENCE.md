...
- [Reference](#reference)
  ...
  - [limitations under the License.](#limitations-under-the-license)
      - [Parameters](#parameters)
        ...
        - [`manage_installdir`](#manage_installdir)
        - [`homedir`](#homedir)
        ...
        - [`use_jndi_ds`](#use_jndi_ds)
        - [`jndi_ds_name`](#jndi_ds_name)
        - [`db`](#db)
        - [`dbname`](#dbname)
        - [`dbuser`](#dbuser)
  ...
  - [Data types](#data-types-1)
    - [`Jira::Jvm_types`](#jirajvm_types)
    - [`Jira::Tomcat_attributes`](#jiratomcat_attributes)
    - [`Jira::Tomcat_connectors`](#jiratomcat_connectors)
...
##### <a name="-jira--manage_installdir"></a>`manage_installdir`

Data type: `Boolean`

Create the installdir. Installdir will not be created when set to false.
...
Create the homedir. Homedir will not be created when set to false.
...
Alias of `Enum['openjdk-11', 'openjdk-17', 'openjdk-21', 'oracle-jdk-1.8']`
